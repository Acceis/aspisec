...
function docsify_js() {
  return src('node_modules/docsify/lib/docsify.min.js', { buffer: false })
    .pipe(dest('../docs/vendor'));
};

function docsify_plugins() {
  return src(['node_modules/docsify/lib/plugins/emoji.min.js',
    'node_modules/docsify/lib/plugins/search.min.js'], { buffer: false })
...
function docsify_themeable_css() {
  return src(['node_modules/docsify-themeable/dist/css/theme-simple.css',
    'node_modules/docsify-themeable/dist/css/theme-simple-dark.css'], { buffer: false })
    .pipe(dest('../docs/vendor/themes'));
};

function docsify_themeable_js() {
  return src('node_modules/docsify-themeable/dist/js/docsify-themeable.min.js', { buffer: false })
    .pipe(dest('../docs/vendor/plugins'));
};

function docsify_tabs_js() {
  return src('node_modules/docsify-tabs/dist/docsify-tabs.min.js', { buffer: false })
    .pipe(dest('../docs/vendor/plugins'));
};

function docsify_image_caption_js() {
  return src('node_modules/@h-hg/docsify-image-caption/dist/docsify-image-caption.min.js', { buffer: false })
    .pipe(dest('../docs/vendor/plugins'));
};

function docsify_sidebar_collapse_js() {
  return src('node_modules/docsify-sidebar-collapse/dist/docsify-sidebar-collapse.min.js', { buffer: false })
    .pipe(dest('../docs/vendor/plugins'));
};

function prismjs_js() {
  return src(['node_modules/prismjs/components/prism-ruby.min.js'], { buffer: false })
